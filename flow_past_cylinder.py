...
ax.set_ylim(bottom=-3, top=3)
ax.set_ylabel('y')
ax.set_title('Time = 6s')
ax.plot(
    [i.location.real for i in sys.linear_panels[0].panel_points],
    [i.location.imag for i in sys.linear_panels[0].panel_points], 'g'
)
fig_v.savefig('vortices_6_second.png')
...
fig_s.savefig('quiver_plot_6_second')
...
velocity = sys.get_total_velocity_chorin(x,y)
ax.quiver(x,y,velocity.real, velocity.imag)
fig_s_half.savefig('quiver_plot_half_6_second')
...
cbar = plt.colorbar(cnt, ax=ax)
cbar.set_label('Vmag')
fig_cnt.savefig('contour_plot_6_second')


#simulate for 7 second
...
ax.set_ylim(bottom=-3, top=3)
ax.set_ylabel('y')
ax.set_title('Time = 7s')
ax.plot(
    [i.location.real for i in sys.linear_panels[0].panel_points],
    [i.location.imag for i in sys.linear_panels[0].panel_points], 'g'
)
fig_v.savefig('vortices_7_second.png')
...
fig_s.savefig('quiver_plot_7_second')
...
velocity = sys.get_total_velocity_chorin(x,y)
ax.quiver(x,y,velocity.real, velocity.imag)
fig_s_half.savefig('quiver_plot_half_7_second')
...
cbar = plt.colorbar(cnt, ax=ax)
cbar.set_label('Vmag')
fig_cnt.savefig('contour_plot_7_second')


#simulate for 8 second
...
ax.set_ylim(bottom=-3, top=3)
ax.set_ylabel('y')
ax.set_title('Time = 8s')
ax.plot(
    [i.location.real for i in sys.linear_panels[0].panel_points],
    [i.location.imag for i in sys.linear_panels[0].panel_points], 'g'
)
fig_v.savefig('vortices_8_second.png')
...
fig_s.savefig('quiver_plot_8_second')
...
velocity = sys.get_total_velocity_chorin(x,y)
ax.quiver(x,y,velocity.real, velocity.imag)
fig_s_half.savefig('quiver_plot_half_8_second')
...
cbar = plt.colorbar(cnt, ax=ax)
cbar.set_label('Vmag')
fig_cnt.savefig('contour_plot_8_second')
...
ax.set_ylim(bottom=-3, top=3)
ax.set_ylabel('y')
ax.set_title('Time = 9s')
ax.plot(
    [i.location.real for i in sys.linear_panels[0].panel_points],
    [i.location.imag for i in sys.linear_panels[0].panel_points], 'g'
)
fig_v.savefig('vortices_9_second.png')
...
fig_s.savefig('quiver_plot_9_second')
...
velocity = sys.get_total_velocity_chorin(x,y)
ax.quiver(x,y,velocity.real, velocity.imag)
fig_s_half.savefig('quiver_plot_half_9_second')
...
cbar = plt.colorbar(cnt, ax=ax)
cbar.set_label('Vmag')
fig_cnt.savefig('contour_plot_9_second')
